...
using ExcelBorderItem = ReportSystem.Excel.ExcelReportConfiguration.Styles.ExcelBorderItem;
using ExcelStyle = ReportSystem.Excel.ExcelReportConfiguration.Styles.ExcelStyle;
